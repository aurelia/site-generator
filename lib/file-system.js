...
exports.copy = function(sourceFile, targetFile) {
  return exports.readFile(sourceFile).then(source => exports.writeFile(targetFile, source));
};
...
exports.copyFolderRecursiveSync = function(source, target) {
  ...
  var targetFolder = nodePath.join(target, nodePath.basename(source));
